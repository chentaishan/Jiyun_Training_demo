...
public class DetailsBean {
    ...
    private java.util.List<GalleryBean> gallery;
    private java.util.List<AttributeBean> attribute;
    private java.util.List<IssueBean> issue;

    private java.util.List<ProductListBean> productList;
